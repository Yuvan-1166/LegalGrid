...
export default function Chat() {
  ...
  return (
    ...
    <button
      ...
      className="fixed top-3 left-3 z-50 p-2 bg-white hover:bg-slate-100 rounded-lg shadow-sm"
    >
      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-0'} transition-all duration-300 bg-slate-50 border-r border-slate-200 flex flex-col overflow-hidden flex-shrink-0`}>
        ...
        <div className="p-3 border-b border-slate-200 flex items-center justify-between">
          ...
          <button
            ...
            className="flex-1 ml-2 px-3 py-2.5 border border-slate-300 hover:bg-slate-100 text-slate-700 rounded-lg text-sm font-medium flex items-center justify-center gap-2"
          >
            + New chat
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Bar */}
        <div className="h-14 border-b border-slate-200 flex items-center justify-between px-4 bg-white flex-shrink-0 pl-14">
